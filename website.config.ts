...
export const PAGE_CHECKOUT_PAYMENTCONFIRM_TITLE         = `Confirm Your Payment - ${WEBSITE_TITLE}`
export const PAGE_CHECKOUT_PAYMENTCONFIRM_DESCRIPTION   = 'Confirm your payment of your order.'
