...
export const [signInInfos, signInInfoValues, cssSignInInfoConfig] = cssConfig(() => {
    const bases = {
        ...
        // edits:
        editJustifySelf      : 'end'                                                            as CssKnownProps['justifySelf'   ],
        editAlignSelf        : 'unset'                                                          as CssKnownProps['alignSelf'     ],
        editMarginBlockStart : spacers.sm                                                       as CssKnownProps['marginBlockEnd'],
    };
