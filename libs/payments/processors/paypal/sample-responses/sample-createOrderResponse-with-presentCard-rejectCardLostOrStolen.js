const sample = {
    ...
    create_time: "2024-12-21T08:59:07Z",
    links: [
        {
        ...
        {
            href: "https://www.sandbox.paypal.com/checkoutnow?token=5B57438865155480N",
            rel: "approve",
            method: "GET",
        },
        {
        ...
        {
            href: "https://api.sandbox.paypal.com/v2/checkout/orders/5B57438865155480N/capture",
            rel: "capture",
            method: "POST",
        },
    ],
