const sample = {
    ...
    create_time: "2024-12-21T08:49:21Z",
    links: [
        {
        ...
        {
            href: "https://www.sandbox.paypal.com/checkoutnow?token=68698180R7386984K",
            rel: "approve",
            method: "GET",
        },
        {
        ...
        {
            href: "https://api.sandbox.paypal.com/v2/checkout/orders/68698180R7386984K/capture",
            rel: "capture",
            method: "POST",
        },
    ],
