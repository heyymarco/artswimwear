const sample = {
    ...
    create_time: "2024-12-21T10:23:48Z",
    links: [
        {
        ...
        {
            href: "https://www.sandbox.paypal.com/checkoutnow?token=09187888J0142203H",
            rel: "approve",
            method: "GET",
        },
        {
        ...
        {
            href: "https://api.sandbox.paypal.com/v2/checkout/orders/09187888J0142203H/capture",
            rel: "capture",
            method: "POST",
        },
    ],
